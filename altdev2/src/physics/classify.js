...
export function classify(w) {
  ...
  if (dg.smallWaterworld && T < 647.096) {
    ...
    id = T < 273.15 ? 'snowball' : dg.smallWaterworld.lifetime < 1e9 ? 'evaporatingWaterworld' : 'smallWaterworld';
  }
  ...
  if (dg.smallWaterworld && T >= 273.15 && T < 647.096) {
