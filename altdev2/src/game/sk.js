...
export const SK = {
  ui: {
    ...
    'Timeline reset to the whole run': 'Časová os zobrazuje opäť celý beh',
    'scroll to zoom · shift-scroll to pan · drag to go back':
      'kolieskom priblížiť · so shiftom posúvať · ťahaním späť v čase',
